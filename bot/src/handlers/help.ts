...
function buildHelpText(role: Role): string {
  ...
  text += "/web <вопрос> — найти свежую информацию в интернете\n";
  text += "\nПоиск можно вызвать в группе клуба: напишите вопрос после команды или ответьте командой на сообщение.\n";
