  ...
  if (!ctx.isClubMember) {
    ...
    await ctx.reply(
      [
        ...
        "🔘 помогать друг другу в том, что знаем и умеем сами",
        "🔘 покупать и сдавать кладовки",
        "🔘 шагать по 10 тыс шагов",
        "🔘 разбарахляться на Авито",
        "🔘 покупать ОФЗ",
        "",
        "- в общем, <b>строить свой капитал</b>, двигаясь маленькими шагами, чтобы спать спокойно и чувствовать себя уверенно)",
        "",
