  ...
  if (!ctx.isClubMember) {
    ...
    await ctx.reply(
      [
        ...
        "<b>И наш бот сообщит тебе, когда откроется окошко в клуб «МОЖНО»!</b>",
        "",
        "<i>______</i>",
        "<i>А в подарок за раннюю регистрацию пришлем тебе нашу клубную методичку «Все фишки Авито»👌</i>",
      ].join("\n"),
      {
        parse_mode: "HTML",
