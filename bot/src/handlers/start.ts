  ...
  if (!ctx.isClubMember) {
    ...
    await ctx.reply(
      [
        ...
        "",
        "- в общем, строим свой капитал, двигаясь маленькими шагами – чтобы спать спокойно и чувствовать себя уверенно)",
        "",
        "Сейчас вход закрыт – жми кнопку⤵️  и наш бот сообщит тебе, когда откроется окошко в клуб «МОЖНО»!",
      ].join("\n"),
      {
        parse_mode: "HTML",
